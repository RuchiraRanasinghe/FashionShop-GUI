...
public class StatusForm extends JFrame {
    ...
    StatusForm(OrdersCollection ordersCollection){
        ...
        btnStatus.setBounds(320,400,150,30);
        btnStatus.setBackground(new Color(102,178,255));
        btnStatus.setForeground(Color.WHITE);
        btnStatus.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt){
                //Status Option
                ordersCollection.changeStatus(ordersCollection.searchOrder(txtOrderId.getText()));
            }
        });
        add(btnStatus);
    }
